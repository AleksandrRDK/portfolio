  ...
  return (
      <section className="contact-me">
        ...
        <div className="contact-me__links">
          ...
          >
            <img src={`${process.env.PUBLIC_URL}/img/api/github-logo.png`} alt="GitHub" className="contact-me__icon" />
            GitHub
          </a>
          <a
            ...
            rel="noopener noreferrer"
          >
            <img src={`${process.env.PUBLIC_URL}/img/social/telegramm-icon.png`} alt="Telegram" className="contact-me__icon" />
            Telegram
          </a>
          <a
            ...
            className="contact-me__link"
          >
            <img src={`${process.env.PUBLIC_URL}/img/social/email-icon.png`} alt="Email" className="contact-me__icon" />
            Электронная почта
          </a>
        </div>
      </section>
